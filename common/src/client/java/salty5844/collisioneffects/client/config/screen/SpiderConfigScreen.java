...
public final class SpiderConfigScreen extends Screen {
	...
	public SpiderConfigScreen(Screen parent) {
		super(Component.literal("Spider"));
		this.parent = parent;
	}
	...
	protected void init() {
		...
		addToggleRow(
			"Hit Spider Splatters",
			config.isEnabled("spider_splatters"),
			contentX,
			rowY,
			value -> config.setEnabled("spider_splatters", value)
		);
