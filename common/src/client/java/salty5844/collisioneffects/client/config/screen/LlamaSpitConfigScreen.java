...
public final class LlamaSpitConfigScreen extends Screen {
	...
	public LlamaSpitConfigScreen(Screen parent) {
		super(Component.literal("Llama"));
		this.parent = parent;
	}
	...
	protected void init() {
		...
		addToggleRow(
			"Damaged by Llama Spit",
			config.isEnabled("llama_spit"),
			contentX,
			rowY,
			value -> config.setEnabled("llama_spit", value)
		);
