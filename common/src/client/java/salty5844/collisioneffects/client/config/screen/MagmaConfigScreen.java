...
public final class MagmaConfigScreen extends Screen {
	...
	public MagmaConfigScreen(Screen parent) {
		super(Component.literal("Magma Cube"));
		this.parent = parent;
	}
	...
	protected void init() {
		...
		addToggleRow(
			"Damaged by Magma Cube Splatters",
			config.isEnabled("magma_damaged_splatters"),
			contentX,
			rowY,
			value -> config.setEnabled("magma_damaged_splatters", value)
		);
		rowY += ROW_HEIGHT;

		addToggleRow(
			"Hit Magma Cube Splatters",
			config.isEnabled("magma_hit_splatters"),
			contentX,
			rowY,
			value -> config.setEnabled("magma_hit_splatters", value)
		);
		rowY += ROW_HEIGHT;

		addToggleRow(
			"Touch Magma Cube Splatters",
			config.isEnabled("magma_touch_splatters"),
			contentX,
			rowY,
			value -> config.setEnabled("magma_touch_splatters", value)
		);
